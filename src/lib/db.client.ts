...
// ---- 常量 ----
const PLAY_RECORDS_KEY = 'TuolingTV_play_records';
const FAVORITES_KEY = 'TuolingTV_favorites';
const SEARCH_HISTORY_KEY = 'TuolingTV_search_history';

// 缓存相关常量
const CACHE_PREFIX = 'TuolingTV_cache_';
